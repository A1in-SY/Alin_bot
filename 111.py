...
class PixivSpider:
    def __init__(self):
        ...
        self.cookie_header = {
            ...
            'cookie' : 'first_visit_datetime_pc=2022-09-08+22%3A49%3A28; p_ab_id=5; p_ab_id_2=9; p_ab_d_id=361732582; yuid_b=JkZCEGU; __utmz=235335808.1662644970.1.1.utmcsr=(direct)|utmccn=(direct)|utmcmd=(none); _fbp=fb.1.1662644971312.667664842; c_type=9; privacy_policy_notification=0; a_type=0; b_type=1; _im_uid.3929=i.siaaAacmQUm8VfV3qLFlKg; login_ever=yes; __utmv=235335808.|2=login%20ever=yes=1^3=plan=normal=1^5=gender=male=1^6=user_id=81243320=1^9=p_ab_id=5=1^10=p_ab_id_2=9=1^11=lang=zh=1; privacy_policy_agreement=5; __utma=235335808.1297637551.1662644969.1663858975.1666603588.3; __utmc=235335808; __utmt=1; _gid=GA1.2.1175319945.1666603589; PHPSESSID=81243320_snPT7prSmQsT3chwDkhe2L4QDdvknH7G; device_token=4158f22e5b08ce17a5c3ff15a4a1fc3d; _ga_MZ1NL4PHH0=GS1.1.1666603589.1.0.1666603593.0.0.0; _ga=GA1.2.1297637551.1662644969; QSI_S_ZN_5hF4My7Ad6VNNAi=v:0:0; _ga_75BBYNYN9J=GS1.1.1666603587.3.1.1666603599.0.0.0; __utmb=235335808.3.10.1666603588; tag_view_ranking=KvAGITxIxH~_Jc3XITZqL~RTJMXD26Ak~LJo91uBPz4~PG_-9m2qFJ~VHF53fMpGT~_Gv-0fiiM4~5GmYXO2AhO~u-76jRUx-u; _im_vid=01GG4N1MD399KEXH2MEWWTRJMB; cto_bundle=1jh4Al9QVTZDcTNWUFIxNWhDOU5qTnZPTHh1Mm0wZDNwTTVSRUFGc09CN3J5eTRHVkJ5ckYwVDdaNGFCZ21RYkx3S0lyU0tZSEN6NXc5R1FWS3olMkZKTWtoZSUyQjhkSnclMkJUSmNCVnZVSGVUZUUxdkxsRk1ybXZNZnNPdW1IYjdzbmlicmRKUngwelhibDQwZjhnV3l2YmI2NlUzNkElM0QlM0Q; __cf_bm=lI3GT6eIdx1dOC6E2mT_n.0ahBW2wpCMgPT7t62YxmQ-1666603604-0-ATtvv136lvBzJCkd3NJJfq9KTizOB8+7kiZlf/QxPsqj9LxiSEduqJ59XZSQ2sA73drrvcLZKpO9dY/zlP8LElxMegCsdjQz88t4eYBDkZnp'
        }
        # 模拟登录的data 
        self.pixiv_id = ''
        self.password = ''
